...
(201, 'Srujana', 'Varada', 'srujana@gmail.com', '9856745896', 'Tadepalligudem','Andhra', 2 ,' Srujana Is a seasoned software engineer with 2 years of experience'),
(202, 'Reethika', 'Koduri', 'reethika@gmail.com', '9836360258', 'Tadepalligudem','Andhra', 4 , 'Reethika has a background in finance with experience in financial analysis'),
(203, 'Manasa', 'priscilla', 'manasa@gmail.com', '8520025021', 'Chennai','Tamil nadu', 4 , 'Manasa is a data analyst with expertise in data analysis'),
(204, 'Durga', 'Rao', 'durga@gmail.com', '7584659820', 'Chennai','Tamil nadu', 2 , 'Durga is a data engineer with experience of 2 years'),
(205, 'Hanisha', 'Mynam', 'hanisha@gmail.com', '7775557001', 'Banglore','Karnataka', 6 , 'Hanisha is an tester with experience of 6 years'),
(206, 'Teja', 'sree', 'teja@gmail.com', '8788554102', 'Banglore','Karnataka', 6 , 'Teja has worked as manager for 10 years'),
(207, 'Ajay', 'Karripetti', 'ajay@gmail.com', '9398097164', 'Tadepalligudem','Andhra', 2 , 'Ajay is a data analyst skilled in data visualization and statistical analysis'),
(208, 'Venkat', 'Kara', 'venkat@gmail.com', '9299605412', 'Pune','Maharashtra', 10 , 'Venkat is an developer with knowledge of multiple languages like Java'),
(209, 'Ammu', 'Bondada', 'ammu@gmail.com', '9491865759', 'Pune','Maharashtra', 6 , 'Ammu has expertise in Designing feild'),
(210, 'Piyush', 'Varma', 'piyush@gmail.com', '9299655412', 'Pune','Maharashtra', 4 , 'Piyush has experience in testing for 4 years');
